% This script works the same as RunFigure2.m except all ode solvers will be ode45.
...
summary_flags.save_output_by_default = true;
base_name = 'figure2H_';
...
input.oxygen_pk_solver = "matlab_solver";
input.oxygen_exchange_solver = "matlab_solver";
input.oxygen_internal_agent_solver = "matlab_solver";
input.oxygen_pde_solver_global_method = "matlab_solver";
